          ...
          >
            ...
            <div className="p-5 lg:p-6 space-y-4 text-sm leading-relaxed">
              ...
              <div className="bg-muted/50 border border-border rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Key performance metrics displayed at a glance for quick assessment of your portfolio health.
                </p>
                <ul className="text-xs text-muted-foreground space-y-2 list-disc list-inside">
                  <li><strong>Total Portfolio Value:</strong> Combined value of all investments and balance</li>
                  <li><strong>Total Profits:</strong> Cumulative earnings from all investments</li>
                  <li><strong>Total ROI:</strong> Overall return on investment percentage</li>
                  <li><strong>Total Deposits:</strong> Sum of all deposits made to your account</li>
                  <li><strong>Total Withdrawals:</strong> Sum of all withdrawals from your account</li>
                  <li><strong>Active Plans:</strong> Number of currently active investment plans</li>
                </ul>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Visual representation of your daily profits over the selected time range. The bar chart shows profit trends and helps identify patterns in your investment performance.
                </p>
                <ul className="text-xs text-muted-foreground space-y-2 list-disc list-inside">
                  <li><strong>Time Range Selection:</strong> Choose from 24h, 7d, 30d, 90d, or 1y views</li>
                  <li><strong>Interactive Bars:</strong> Hover over bars to see exact profit amounts</li>
                  <li><strong>Performance Metrics:</strong> Daily ROI, Weekly Growth, Success Rate, Risk Score</li>
                  <li><strong>Visual Trends:</strong> Sparkline indicators show profit direction</li>
                </ul>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Detailed breakdown of your portfolio by investment type. See which plans contribute most to your portfolio value.
                </p>
                <ul className="text-xs text-muted-foreground space-y-2 list-disc list-inside">
                  <li><strong>Investment Names:</strong> Each plan tier displayed separately</li>
                  <li><strong>Value Breakdown:</strong> Dollar amount invested in each plan</li>
                  <li><strong>Percentage Distribution:</strong> Visual bar showing portfolio allocation</li>
                  <li><strong>Color Coding:</strong> Different colors for easy identification</li>
                </ul>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Real-time feed of your recent account activities including deposits, withdrawals, investments, and profit payouts.
                </p>
                <ul className="text-xs text-muted-foreground space-y-2 list-disc list-inside">
                  <li><strong>Activity Types:</strong> Deposits, Withdrawals, Investments, Profits, Gifts</li>
                  <li><strong>Timestamps:</strong> Exact time of each activity</li>
                  <li><strong>Amounts:</strong> Transaction amounts with color coding</li>
                  <li><strong>Quick Access:</strong> Link to full transaction history</li>
                </ul>
              </div>
              ...
              <div className="bg-muted/50 border border-border rounded-xl p-4 space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  All analytics data updates in real-time. Use the refresh button to manually fetch the latest data. The dashboard automatically loads when you visit the page.
                </p>
                <ul className="text-xs text-muted-foreground space-y-2 list-disc list-inside">
