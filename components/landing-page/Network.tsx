...
export default function Network() {
  return (
    <section className="relative py-24 w-full flex items-center justify-center overflow-hidden mt-10 lg:mt-10 mb-10 lg:mb-10">
      <div
        className="absolute inset-0 bg-cover bg-fixed bg-center z-0"
        style={{
          backgroundImage:
            "url('https://i.postimg.cc/nLKrD8QX/up2.jpg')",
        }}
      >
